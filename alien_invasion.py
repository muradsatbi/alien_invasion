...
class AlienInvasion:
    ...
    def run_game(self):
        ...
        while True:
            ...
            # Событие - действие, выполняемое пользователем
            # во время игры
            for event in pygame.event.get():
                # цикл событий для получения событий
                if event.type == pygame.QUIT:
                    # Условие, если тип события - это pygame.QUIT,
                    # то есть, нажатие крестика в правом углу
                    # то система выходит из игрового окна
                    sys.exit()
...
if __name__ == 'main':
    ...
    # Эти два аспекта заключены в блок if, чтобы запуск
    # игры совершался только при прямом вызове функции
    ai = AlienInvasion()
    ai.run_game()
